  ...
  ({ className, type, ...props }, ref) => {
    return (
      <input
        ...
        ref={ref}
        className={cn(
          "flex h-11 w-full rounded-field border border-line bg-elevated px-3.5 text-sm text-fg shadow-sm transition-all duration-150",
          "placeholder:text-muted/70 hover:border-accent/40",
